...
urlpatterns = patterns('',
    ...
    # url(r'^admin/task$', views.listtask),
    # url(r'^admin/task/new$',views.newtask),
    # url(r'^admin/task/(?P<id>\d+)/edit$',views.edittask),
    # url(r'^admin/subtask$', views.listsubtask),
    # url(r'^admin/subtask/new$',views.newsubtask),
    # url(r'^admin/subtask/(?P<id>\d+)/edit$',views.editsubtask),
)
